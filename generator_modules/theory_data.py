# -*- coding: utf-8 -*-
"""
Comprehensive Theory Bank - VACPA Planner 2026
7 Môn học chia làm 4 phần A/B/C/D bám sát 100% đề cương Bộ Tài chính 2026
"""

def get_theory_bank():
    # Construct complete dictionary for 7 subjects
    tb = {
        "PL": {
            "subjectId": "PL",
            ...
            "parts": {
                "A": {
                    ...
                    "flashcards": [
                        {"q": "Thời hạn góp vốn khi thành lập công ty TNHH và CTCP là bao lâu?", "a": "90 ngày kể từ ngày được cấp Giấy chứng nhận đăng ký doanh nghiệp (không tính thời gian vận chuyển, làm thủ tục hải quan tài sản góp vốn)."},
                        {"q": "Số lượng thành viên tối đa của Công ty TNHH 2TV trở lên là bao nhiêu?", "a": "Tối đa 50 thành viên."},
                        {"q": "Cổ phần ưu đãi biểu quyết có hiệu lực trong bao lâu đối với cổ đông sáng lập?", "a": "Hiệu lực trong 03 năm kể từ ngày công ty được cấp GCN ĐKDN. Sau 3 năm, CP ưu đãi biểu quyết của CĐSL chuyển đổi thành CP phổ thông."},
                        {"q": "Chủ doanh nghiệp tư nhân có được thành lập công ty TNHH 1TV không?", "a": "Được thành lập công ty TNHH (vì TNHH chịu trách nhiệm hữu hạn), nhưng KHÔNG được làm chủ DNTN khác hoặc thành viên hợp danh công ty hợp danh."}
                    ]
                },
                "B": {
                    "part": "B",
                    ...
                    "flashcards": [
                        {"q": "Điều kiện quan trọng nhất để doanh nghiệp được làm thủ tục giải thể tự nguyện?", "a": "Phải thanh toán hết tất cả các khoản nợ và nghĩa vụ tài sản, không trong quá trình giải quyết tranh chấp tại Tòa án hoặc Trọng tài."},
                        {"q": "Thứ tự ưu tiên thanh toán số 1 khi giải thể doanh nghiệp là gì?", "a": "Nợ lương, trợ cấp thôi việc, bảo hiểm xã hội, bảo hiểm y tế, bảo hiểm thất nghiệp của người lao động."},
                        {"q": "Tổ chức kinh tế có vốn ĐTNN nắm giữ bao nhiêu % vốn điều lệ thì phải áp dụng điều kiện đầu tư như NĐT nước ngoài?", "a": "Trên 50% vốn điều lệ (theo Luật Đầu tư mới)."}
                    ]
                },
                "C": {
                    "part": "C",
                    ...
                    "flashcards": [
                        {"q": "Mức phạt vi phạm hợp đồng thương mại tối đa theo Luật Thương mại 2005 là bao nhiêu?", "a": "Tối đa 8% giá trị phần nghĩa vụ hợp đồng bị vi phạm (Điều 301 LTM 2005)."},
                        {"q": "Nếu hợp đồng chỉ ghi điều khoản phạt vi phạm 10%, xử lý thế nào?", "a": "Điều khoản phạt vượt quá 8% bị coi là vô hiệu một phần. Tòa án/Trọng tài chỉ chấp nhận mức phạt tối đa 8% phần nghĩa vụ bị vi phạm."},
                        {"q": "Một doanh nghiệp được coi là có vị trí thống trị thị trường khi có thị phần bao nhiêu?", "a": "Thị phần từ 30% trở lên trên thị trường liên quan, hoặc có sức mạnh thị trường đáng kể theo Luật Cạnh tranh 2018."}
                    ]
                },
                "D": {
                    "part": "D",
                    ...
                    "flashcards": [
                        {"q": "Doanh nghiệp mất khả năng thanh toán theo Luật Phục hồi, phá sản khi nào?", "a": "Khi không thực hiện nghĩa vụ thanh toán khoản nợ trong thời hạn 03 tháng kể từ ngày đến hạn thanh toán."},
                        {"q": "Phán quyết của Trọng tài thương mại có bị kháng cáo lên Tòa án cấp phúc thẩm không?", "a": "Không. Phán quyết trọng tài là chung thẩm, có hiệu lực thi hành ngay đối với các bên."},
                        {"q": "Mức tiền lương làm thêm giờ vào ngày nghỉ Lễ, Tết được tính tối thiểu bao nhiêu %?", "a": "Ít nhất bằng 300% đơn giá tiền lương hoặc tiền lương thực trả theo công việc đang làm (chưa kể tiền lương ngày lễ, tết có hưởng lương)."}
                    ]
                }
            }
        },
        "TC": {
            ...
            "parts": {
                "A": {
                    ...
                    "formulas": [
                        {"name": "FV tiền đơn", "expr": "FV = PV * (1 + r)^n"},
                        {"name": "PV tiền đơn", "expr": "PV = FV / (1 + r)^n"},
                        {"name": "PVA (Hiện tại chuỗi đều cuối kỳ)", "expr": "PVA = A * [1 - (1 + r)^(-n)] / r"},
                        {"name": "FVA (Tương lai chuỗi đều cuối kỳ)", "expr": "FVA = A * [(1 + r)^n - 1] / r"},
                        {"name": "Mô hình CAPM", "expr": "Re = Rf + Beta * (Rm - Rf)"},
                        {"name": "Hệ số biến thiên", "expr": "CV = sigma / E(R)"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Công thức tính giá trị hiện tại của dòng tiền đều vô hạn tăng trưởng với tốc độ g?", "a": "PV = CF1 / (r - g) (với r > g)."},
                        {"q": "Trong mô hình CAPM, đại lượng (Rm - Rf) mang ý nghĩa gì?", "a": "Phần bù rủi ro thị trường (Market Risk Premium), phản ánh mức sinh lời bổ sung mà nhà đầu tư đòi hỏi khi chấp nhận đầu tư vào danh mục thị trường thay vì tài sản phi rủi ro."},
                        {"q": "Nếu Beta của cổ phiếu = 1.5, điều đó có nghĩa là gì?", "a": "Khi thị trường biến động 1% thì tỷ suất sinh lời của cổ phiếu có xu hướng biến động 1.5% theo cùng chiều."}
                    ]
                },
                "B": {
                    "part": "B",
                    ...
                    "formulas": [
                        {"name": "Định giá trái phiếu", "expr": "Vb = I * [(1 - (1+r)^(-n)) / r] + M / (1+r)^n"},
                        {"name": "Mô hình Gordon", "expr": "P0 = D1 / (rs - g) = D0 * (1 + g) / (rs - g)"},
                        {"name": "Nhu cầu vốn ngoài (AFN)", "expr": "AFN = (A*/S0)*Delta_S - (L*/S0)*Delta_S - ROS*S1*(1 - d)"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Khi lãi suất chiết khấu thị trường cao hơn lãi suất danh nghĩa trên trái phiếu, trái phiếu được bán ở mức giá nào?", "a": "Bán chiết khấu (thấp hơn mệnh giá, Vb < M)."},
                        {"q": "Các khoản nợ nào trong Bảng CĐKT thường tăng tự động theo doanh thu trong công thức AFN?", "a": "Phải trả người bán, nợ lương người lao động, các khoản thuế và nợ Nhà nước (Nợ ngắn hạn chiếm dụng phi tài chính). Vay ngắn hạn ngân hàng và nợ dài hạn KHÔNG tăng tự động!"}
                    ]
                },
                "C": {
                    "part": "C",
                    ...
                    "formulas": [
                        {"name": "Dòng tiền OCF", "expr": "OCF = EBIT*(1 - T) + Khấu hao"},
                        {"name": "NPV", "expr": "NPV = Tổng [CFt / (1+r)^t] - CF0"},
                        {"name": "Chỉ số sinh lời PI", "expr": "PI = PV(Dòng tiền thu hồi) / CF0"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Tại sao chi phí chìm (Sunk cost) không được tính vào dòng tiền của dự án đầu tư?", "a": "Vì chi phí chìm đã phát sinh trong quá khứ và không thể thay đổi bất kể dự án có được chấp thuận hay không."},
                        {"q": "Khi nào xảy ra xung đột giữa tiêu chuẩn NPV và IRR?", "a": "Khi đánh giá các dự án loại trừ nhau có quy mô vốn ban đầu chênh lệch lớn hoặc thời gian thu hồi dòng tiền rất khác nhau. Luôn ưu tiên chọn dự án có NPV lớn hơn."}
                    ]
                },
                "D": {
                    "part": "D",
                    ...
                    "formulas": [
                        {"name": "WACC", "expr": "WACC = wd*rd*(1 - T) + wp*rp + ws*rs"},
                        {"name": "DOL (Đòn bẩy kinh doanh)", "expr": "DOL = (EBIT + F) / EBIT"},
                        {"name": "DFL (Đòn bẩy tài chính)", "expr": "DFL = EBIT / (EBIT - I)"},
                        {"name": "DTL (Đòn bẩy tổng hợp)", "expr": "DTL = DOL * DFL"},
                        {"name": "Sản lượng hòa vốn", "expr": "Q_hv = F / (P - v)"},
                        {"name": "Mô hình EOQ", "expr": "EOQ = sqrt((2 * D * S) / H)"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Tại sao chi phí sử dụng nợ vay sau thuế lại thấp hơn chi phí nợ vay trước thuế?", "a": "Vì chi phí lãi vay được tính vào chi phí hợp lý khi xác định thu nhập chịu thuế TNDN, tạo ra lá chắn thuế (Tax shield) làm giảm số thuế phải nộp: rd(sau thuế) = rd * (1 - T)."},
                        {"q": "Nếu DOL = 2 và DFL = 1.5, khi doanh thu tăng 10% thì EPS tăng bao nhiêu %?", "a": "DTL = DOL * DFL = 2 * 1.5 = 3. Khi doanh thu tăng 10% thì EPS tăng = 10% * 3 = 30%."},
                        {"q": "Trong mô hình EOQ, nếu nhu cầu hàng năm tăng gấp 4 lần thì quy mô mỗi lần đặt hàng tối ưu tăng mấy lần?", "a": "Tăng căn bậc hai của 4 = 2 lần."}
                    ]
                }
            }
        },
        "TH": {
            ...
            "parts": {
                "A": {
                    ...
                    "formulas": [
                        {"name": "Thuế GTGT khấu trừ", "expr": "Thuế GTGT phải nộp = Thuế GTGT đầu ra - Thuế GTGT đầu vào được khấu trừ"},
                        {"name": "Phân bổ thuế đầu vào", "expr": "Thuế ĐV được KT = Thuế ĐV dùng chung * (Doanh thu chịu thuế / Tổng doanh thu)"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Sự khác biệt cốt lõi giữa đối tượng chịu thuế GTGT 0% và đối tượng không chịu thuế GTGT?", "a": "Thuế suất 0% được kê khai, khấu trừ và hoàn thuế GTGT đầu vào; Không chịu thuế GTGT thì không được khấu trừ thuế đầu vào (phải tính vào chi phí hoặc nguyên giá TSCĐ)."},
                        {"q": "Điều kiện chứng từ thanh toán để được khấu trừ thuế GTGT đầu vào đối với hóa đơn từ 20 triệu đồng trở lên?", "a": "Phải có chứng từ thanh toán không dùng tiền mặt (thanh toán qua ngân hàng)."},
                        {"q": "Chiếc ô tô 5 chỗ ngồi dùng cho giám đốc doanh nghiệp sản xuất trị giá 2.5 tỷ đồng (chưa thuế GTGT) thì thuế GTGT đầu vào được khấu trừ bao nhiêu?", "a": "Chỉ được khấu trừ thuế GTGT đầu vào tối đa tương ứng phần nguyên giá 1.6 tỷ đồng (= 160 triệu đồng). Phần thuế GTGT của giá trị vượt trên 1.6 tỷ không được khấu trừ (trừ DN kinh doanh vận tải, du lịch, khách sạn)."}
                    ]
                },
                "B": {
                    "part": "B",
                    ...
                    "formulas": [
                        {"name": "Giá tính thuế TTĐB", "expr": "Giá tính thuế TTĐB = (Giá bán chưa thuế GTGT - Thuế BVMT) / (1 + Thuế suất TTĐB)"},
                        {"name": "Thuế TTĐB phải nộp", "expr": "Thuế TTĐB = Giá tính thuế TTĐB * Thuế suất - Thuế TTĐB nguyên liệu được khấu trừ"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Công thức xác định giá tính thuế TTĐB của hàng hóa sản xuất trong nước bán ra?", "a": "Giá tính thuế TTĐB = (Giá bán chưa có thuế GTGT - Thuế BVMT nếu có) / (1 + Thuế suất thuế TTĐB)."},
                        {"q": "Điều hòa nhiệt độ có công suất bao nhiêu thì thuộc đối tượng chịu thuế TTĐB?", "a": "Từ 90.000 BTU trở xuống."}
                    ]
                },
                "C": {
                    "part": "C",
                    ...
                    "formulas": [
                        {"name": "Thuế TNDN phải nộp", "expr": "Thuế TNDN = (Thu nhập tính thuế - Quỹ KHCN) * Thuế suất (20%)"},
                        {"name": "Thu nhập tính thuế", "expr": "TNTT = (Doanh thu - Chi phí được trừ + TN khác) - TN miễn thuế - Lỗ kết chuyển"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Doanh nghiệp có vốn điều lệ còn thiếu 500 triệu đồng, trong năm đi vay ngân hàng 1 tỷ đồng với lãi suất 10%/năm (chi phí lãi vay 100 triệu). Khoản chi phí lãi vay được trừ và không được trừ là bao nhiêu?", "a": "Chi phí lãi vay không được trừ = 500 triệu * 10% = 50 triệu đồng (tương ứng vốn điều lệ còn thiếu). Chi phí lãi vay được trừ = 100 - 50 = 50 triệu đồng."},
                        {"q": "Thời gian chuyển lỗ tối đa theo Luật thuế TNDN là bao nhiêu năm?", "a": "Tối đa không quá 05 năm liên tục, kể từ năm tiếp sau năm phát sinh lỗ."}
                    ]
                },
                "D": {
                    "part": "D",
                    ...
                    "flashcards": [
                        {"q": "Tiêu chí số ngày có mặt tại Việt Nam để xác định cá nhân cư trú là bao nhiêu ngày?", "a": "Từ 183 ngày trở lên tính trong một năm dương lịch hoặc trong 12 tháng liên tục kể từ ngày đầu tiên có mặt tại Việt Nam."},
                        {"q": "Mức thuế suất thuế TNCN đối với thu nhập từ chuyển nhượng bất động sản là bao nhiêu?", "a": "2% tính trên giá chuyển nhượng bất động sản từng lần."},
                        {"q": "Mức trần chi phí lãi vay được trừ đối với doanh nghiệp có giao dịch liên kết theo Nghị định 132/2020/NĐ-CP là bao nhiêu?", "a": "Tối đa không vượt quá 30% tổng lợi nhuận thuần từ hoạt động kinh doanh cộng chi phí lãi vay thuần cộng chi phí khấu hao (30% EBITDA). Phần vượt được chuyển sang các kỳ tính thuế tiếp theo trong vòng 5 năm."}
                    ]
                }
            }
        },
        "KT": {
            ...
            "parts": {
                "A": {
                    ...
                    "flashcards": [
                        {"q": "Nguyên tắc cơ sở dồn tích (Accrual basis) quy định thời điểm ghi nhận nghiệp vụ kinh tế tài chính như thế nào?", "a": "Ghi nhận vào thời điểm phát sinh, không căn cứ vào thời điểm thực tế thu hoặc thực tế chi tiền hoặc tương đương tiền."},
                        {"q": "Nếu đơn vị kế toán thay đổi phương pháp tính giá xuất kho từ Bình quân gia quyền sang FIFO thì phải làm gì theo nguyên tắc nhất quán?", "a": "Phải giải trình trong Thuyết minh BCTC về lý do thay đổi và ảnh hưởng của sự thay đổi đó đến tình hình tài chính và kết quả kinh doanh của doanh nghiệp."}
                    ]
                },
                "B": {
                    "part": "B",
                    ...
                    "formulas": [
                        {"name": "Giá trị thuần có thể thực hiện (NRV)", "expr": "NRV = Giá bán ước tính - Chi phí hoàn thành - Chi phí bán hàng"},
                        {"name": "Mức trích dự phòng HTK", "expr": "Mức dự phòng = Lượng tồn kho * (Giá gốc đơn vị - NRV đơn vị)"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Nguyên tắc đánh giá hàng tồn kho cuối kỳ kế toán theo VAS 02 là gì?", "a": "Ghi nhận theo giá thấp hơn giữa Giá gốc và Giá trị thuần có thể thực hiện được (NRV)."},
                        {"q": "Bút toán trích lập dự phòng giảm giá hàng tồn kho cuối kỳ?", "a": "Nợ TK 632 (Giá vốn hàng bán) / Có TK 2294 (Dự phòng giảm giá hàng tồn kho)."}
                    ]
                },
                "C": {
                    "part": "C",
                    ...
                    "formulas": [
                        {"name": "Dòng tiền HĐKD gián tiếp", "expr": "CFO = LNTT + Khấu hao + Dự phòng + Chi phí lãi vay - Lãi bán TSCĐ - Tăng Phải thu - Tăng Tồn kho + Tăng Phải trả - Thuế TNDN đã nộp"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Khi nào chi phí đi vay được vốn hóa vào giá trị tài sản dở dang theo VAS 16?", "a": "Khi chi phí đi vay phát sinh liên quan trực tiếp đến việc đầu tư xây dựng hoặc sản xuất tài sản dở dang cần một thời gian đủ dài (trên 12 tháng) để có thể đưa vào sử dụng hoặc bán."},
                        {"q": "Chênh lệch tạm thời được khấu trừ làm phát sinh khoản mục nào trên Bảng cân đối kế toán?", "a": "Tài sản thuế thu nhập hoãn lại (TK 243)."}
                    ]
                },
                "D": {
                    "part": "D",
                    ...
                    "formulas": [
                        {"name": "Lợi thế thương mại (Goodwill)", "expr": "Goodwill = Giá phí hợp nhất - (% Sở hữu * GTHL tài sản thuần ngày mua)"},
                        {"name": "Số dư đảm phí (CM)", "expr": "CM = Doanh thu - Tổng biến phí = Q * (P - v)"},
                        {"name": "Doanh thu hòa vốn", "expr": "S_hv = F / CMR = F / [1 - (v/P)]"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Công thức xác định Lợi thế thương mại (Goodwill) tại ngày mua theo Thông tư 202?", "a": "Goodwill = Giá phí hợp nhất kinh doanh - Phần sở hữu của bên mua trong Giá trị hợp lý của tài sản thuần có thể xác định được của bên bị mua."},
                        {"q": "Thời gian phân bổ tối đa của Lợi thế thương mại vào chi phí theo chế độ kế toán Việt Nam?", "a": "Tối đa không quá 10 năm kể từ ngày mua."},
                        {"q": "Công thức tính Doanh thu hòa vốn theo phương pháp Số dư đảm phí?", "a": "Doanh thu hòa vốn = Tổng định phí / Tỷ lệ số dư đảm phí = F / [(P - v) / P]."}
                    ]
                }
            }
        },
        "KI": {
            ...
            "parts": {
                "A": {
                    ...
                    "flashcards": [
                        {"q": "5 nguyên tắc đạo đức nghề nghiệp cơ bản của kiểm toán viên là gì?", "a": "1. Tính chính trực; 2. Tính khách quan; 3. Năng lực chuyên môn và tính thận trọng; 4. Tính bảo mật; 5. Tư cách nghề nghiệp."},
                        {"q": "Khi kiểm toán viên sở hữu cổ phiếu của công ty khách hàng kiểm toán thì phát sinh nguy cơ nào?", "a": "Nguy cơ tư lợi (Self-interest threat). KTV phải bán toàn bộ cổ phiếu trước khi tham gia cuộc kiểm toán hoặc rút khỏi nhóm kiểm toán."},
                        {"q": "Việc vừa thực hiện dịch vụ lập BCTC vừa nhận kiểm toán BCTC cho cùng một khách hàng tạo ra nguy cơ nào lớn nhất?", "a": "Nguy cơ tự kiểm tra (Self-review threat)."}
                    ]
                },
                "B": {
                    "part": "B",
                    ...
                    "formulas": [
                        {"name": "Mô hình rủi ro kiểm toán", "expr": "AR = RoMM * DR = IR * CR * DR"},
                        {"name": "Rủi ro phát hiện cần đạt", "expr": "DR = AR / (IR * CR)"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Trong mô hình rủi ro kiểm toán AR = IR * CR * DR, thành phần rủi ro nào là do kiểm toán viên kiểm soát được?", "a": "Rủi ro phát hiện (Detection Risk - DR). KTV kiểm soát DR thông qua việc thiết kế nội dung, lịch trình và phạm vi các thủ tục kiểm toán."},
                        {"q": "Mức trọng yếu thực hiện (Performance Materiality) có mục đích gì?", "a": "Được thiết lập thấp hơn mức trọng yếu tổng thể để hạn chế rủi ro tổng hợp của các sai sót không được điều chỉnh và không được phát hiện vượt quá mức trọng yếu của toàn bộ BCTC."}
                    ]
                },
                "C": {
                    "part": "C",
                    ...
                    "flashcards": [
                        {"q": "Để kiểm tra cơ sở dẫn liệu 'Tính đầy đủ' của nợ phải trả người bán, KTV phải chọn mẫu kiểm tra theo hướng nào?", "a": "Chọn mẫu từ các chứng từ gốc độc lập (như Phiếu nhập kho, Biên bản nghiệm thu, Hóa đơn của người bán) rồi đối chiếu vào Sổ nhật ký mua hàng và Sổ cái để xem có bị bỏ sót không."},
                        {"q": "Bằng chứng nào có độ tin cậy cao hơn: Thư xác nhận số dư tài khoản ngân hàng gửi trực tiếp cho KTV hay Giấy báo có do khách hàng cung cấp?", "a": "Thư xác nhận ngân hàng gửi trực tiếp cho KTV có độ tin cậy cao hơn vì bắt nguồn từ bên thứ ba độc lập và gửi trực tiếp cho KTV."}
                    ]
                },
                "D": {
                    "part": "D",
                    ...
                    "flashcards": [
                        {"q": "Khi BCTC có sai sót trọng yếu nhưng không lan tỏa đối với tổng thể BCTC thì KTV đưa ra loại ý kiến nào?", "a": "Ý kiến kiểm toán ngoại trừ (Qualified Opinion)."},
                        {"q": "Sự khác biệt giữa Ý kiến Trái ngược (Adverse) và Từ chối đưa ra ý kiến (Disclaimer)?", "a": "Ý kiến trái ngược: KTV đã có bằng chứng về sai sót vừa trọng yếu vừa lan tỏa. Từ chối ý kiến: KTV bị giới hạn phạm vi kiểm toán nên không thu thập được bằng chứng mà ảnh hưởng có thể vừa trọng yếu vừa lan tỏa."},
                        {"q": "Đoạn 'Vấn đề cần nhấn mạnh' (Emphasis of Matter) có làm thay đổi ý kiến kiểm toán không?", "a": "Không. Ý kiến kiểm toán không bị thay đổi vì vấn đề này đã được đơn vị trình bày và thuyết minh thích hợp trong BCTC."}
                    ]
                }
            }
        },
        "PT": {
            ...
            "parts": {
                "A": {
                    ...
                    "formulas": [
                        {"name": "Thay thế liên hoàn (Q = a*b*c)", "expr": "Delta_Q(a) = (a1 - a0)*b0*c0; Delta_Q(b) = a1*(b1 - b0)*c0; Delta_Q(c) = a1*b1*(c1 - c0)"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Nguyên tắc cơ bản khi áp dụng phương pháp thay thế liên hoàn để phân tích nhân tố là gì?", "a": "Xác định rõ mối quan hệ toán học giữa các nhân tố với chỉ tiêu phân tích, sắp xếp các nhân tố theo trật tự logic (số lượng trước, chất lượng sau) và lần lượt thay thế giá trị kỳ gốc bằng giá trị kỳ phân tích."}
                    ]
                },
                "B": {
                    "part": "B",
                    ...
                    "formulas": [
                        {"name": "Vốn lưu động ròng (NWC)", "expr": "NWC = Nguồn vốn dài hạn - TSDH = TSNH - Nợ ngắn hạn"},
                        {"name": "Nhu cầu vốn lưu động (WCR)", "expr": "WCR = (HTK + Phải thu ngắn hạn) - Nợ ngắn hạn chiếm dụng"},
                        {"name": "Ngân quỹ ròng (NT)", "expr": "NT = NWC - WCR = Tiền - Vay ngắn hạn"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Nếu Vốn lưu động ròng (NWC) âm (< 0), điều đó phản ánh trạng thái tài chính nào của doanh nghiệp?", "a": "Doanh nghiệp đang sử dụng một phần nguồn vốn ngắn hạn (nợ ngắn hạn) để tài trợ cho tài sản dài hạn. Đây là trạng thái tài chính mạo hiểm, rủi ro thanh khoản cao."},
                        {"q": "Mối quan hệ giữa NWC, WCR và Ngân quỹ ròng NT được xác định bằng công thức nào?", "a": "NT = NWC - WCR."}
                    ]
                },
                "C": {
                    "part": "C",
                    ...
                    "formulas": [
                        {"name": "Current Ratio (Thanh toán hiện hành)", "expr": "CR = Tài sản ngắn hạn / Nợ ngắn hạn"},
                        {"name": "Quick Ratio (Thanh toán nhanh)", "expr": "QR = (TSNH - Hàng tồn kho) / Nợ ngắn hạn"},
                        {"name": "Interest Coverage Ratio (Thanh toán lãi vay)", "expr": "ICR = EBIT / Chi phí lãi vay I"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "Tại sao khi tính hệ số thanh toán nhanh (Quick Ratio) phải loại trừ hàng tồn kho?", "a": "Vì hàng tồn kho là tài sản có tính thanh khoản thấp nhất trong tài sản ngắn hạn, cần thời gian để tiêu thụ và chuyển đổi thành tiền, đồng thời có rủi ro giảm giá hoặc lỗi thời."},
                        {"q": "Dấu hiệu nào trên Báo cáo LCTT cho thấy chất lượng lợi nhuận của doanh nghiệp đang ở mức thấp?", "a": "Lợi nhuận sau thuế dương rất cao nhưng Dòng tiền thuần từ hoạt động kinh doanh (OCF) lại liên tục âm hoặc thấp hơn nhiều so với LNST."}
                    ]
                },
                "D": {
                    "part": "D",
                    ...
                    "formulas": [
                        {"name": "Chu kỳ chuyển đổi tiền (CCC)", "expr": "CCC = DIO + DSO - DPO"},
                        {"name": "ROA", "expr": "ROA = ROS * ATO = (LNST / Doanh thu) * (Doanh thu / Tổng TS)"},
                        {"name": "Mô hình DuPont 3 nhân tố", "expr": "ROE = ROS * ATO * FL = (LNST/Doanh thu) * (Doanh thu/Tổng TS) * (Tổng TS/Vốn CSH)"}
                    ],
                    "pitfalls": [
                    ...
                    "flashcards": [
                        {"q": "3 nhân tố cấu thành nên Tỷ suất sinh lời trên vốn CSH (ROE) trong mô hình DuPont 3 bước là gì?", "a": "1. Tỷ suất lợi nhuận ròng trên doanh thu (ROS); 2. Vòng quay tổng tài sản (ATO); 3. Hệ số đòn bẩy tài chính (Hệ số nhân vốn CSH = Tổng tài sản / Vốn CSH)."},
                        {"q": "Công thức tính Chu kỳ chuyển đổi tiền mặt (Cash Conversion Cycle - CCC)?", "a": "CCC = Số ngày tồn kho bình quân (DIO) + Kỳ thu tiền bình quân (DSO) - Kỳ trả tiền bình quân (DPO)."}
                    ]
                }
            }
        },
        "TA": {
            ...
            "parts": {
                "A": {
                    ...
                    "flashcards": [
                        {"q": "What is the primary English term for 'Tài sản cố định hữu hình'?", "a": "Property, Plant and Equipment (PPE) hoặc Tangible Fixed Assets."},
                        {"q": "Translate into Vietnamese: 'Accounts Payable' and 'Accounts Receivable'?", "a": "Accounts Payable = Phải trả người bán (Nợ phải trả); Accounts Receivable = Phải thu khách hàng (Tài sản)."}
                    ]
                },
                "B": {
                    "part": "B",
                    ...
                    "flashcards": [
                        {"q": "Translate into English: 'Lợi nhuận gộp' và 'Giá vốn hàng bán'?", "a": "Gross Profit and Cost of Goods Sold (COGS)."},
                        {"q": "What does CFO stand for in Statement of Cash Flows?", "a": "Cash Flows from Operating activities (Lưu chuyển tiền thuần từ hoạt động kinh doanh)."}
                    ]
                },
                "C": {
                    "part": "C",
                    ...
                    "flashcards": [
                        {"q": "Translate into English: 'Ý kiến kiểm toán ngoại trừ'?", "a": "Qualified audit opinion."},
                        {"q": "What is the English phrase for 'Đoạn vấn đề cần nhấn mạnh' in an auditor's report?", "a": "Emphasis of Matter paragraph."}
                    ]
                },
                "D": {
                    "part": "D",
                    ...
                    "flashcards": [
                        {"q": "Translate into Vietnamese: 'The financial statements give a true and fair view of the financial position of the company'?", "a": "Báo cáo tài chính phản ánh trung thực và hợp lý tình hình tài chính của công ty."}
                    ]
                }
            }
        }
